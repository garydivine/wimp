...
public class SeedData {
	...
	public SeedData(MovieRepository movieRepo, ActorRepository actorRepo, AwardRepository awardRepo) {
		...
		// Add an award to actor
		awardRepo.save(new Award("Golden Globe", "Something", 2001, actor));
	}
}
